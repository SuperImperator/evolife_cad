...
<title>EVOLIFE - Anruf Bearbeiten</title>
...
<div class="container" style="margin-top: 25px;">
	<div class="row">
		...
		<div class="col-md-6">
			<div class="card">
				<div class="card-header">Anruf Bearbeiten</div>
				<div class="card-body">
					<?php
						if(isset($_POST['createCall'])) {
			  	  			createCall($_POST['type'],$_POST['location'],$_POST['civilian'],$_POST['description']);
                    ?>
                    <div class="alert alert-success"><b>Anruf gesendet</b> Der Anruf wurde an den Kontrollraum gesendet.</div>
                    <?php
						}
					?>
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select name="civilian" class="form-control">
                                <option value="0">Anruf beenden</option>
                                <?php
                                $civs = getCivs();
                        ...
                        <div class="form-group col-md-12">
                            <label for="channel">Informationen öffnen</label>
