...
?>
<title>EVOLIFE - Kennzeichensuche</title>
...
<div class="container" style="margin-top: 25px;">
	<div class="row">
		...
		<div class="col-md-6">
			<div class="card">
				<div class="card-header">Kennzeichensuche</div>
				<div class="card-body">
					<?php
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						<div class="form-group col-md-12">
  						...
  						<div class="form-group" style="width: 100%;">
							<input type="submit" name='searchVRM' class="btn btn-success btn-block" value="Suchen">
						</div>
					</form>
				</div>
			</div>
