...
<head>
<title>EVOLIFE - Zivile Suche</title>
<style type="text/css">
body {
...
<div class="container" style="margin-top: 25px;">
	<div class="row">
		...
		<div class="col-md-6">
			<div class="card">
				<div class="card-header">Zivile Suche</div>
				<div class="card-body">
					<?php
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						<div class="form-group col-md-12">
    						<label for="channel">Zivilist Name</label>
                        ...
                        <div class="form-group col-md-12">
  						...
  						<div class="form-group" style="width: 100%;">
							<input type="submit" name='searchPNC' class="btn btn-success btn-block" value="Suche">
						</div>
					</form>
				</div>
			</div>
